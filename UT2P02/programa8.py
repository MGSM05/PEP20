...
print(f"Jugador 1 sacó: {dado1_j1} y {dado2_j1} -> Total: {total_j1}")
print(f"Jugador 2 sacó: {dado1_j2} y {dado2_j2} -> Total: {total_j2}")
...
if total_j1 > total_j2:
    ...
    if max_j1 > max_j2:
        print("\nGana el Jugador 1 (por dado más alto)!!")
    elif max_j2 > max_j1:
        print("\nGana el Jugador 2 (por dado más alto)!!")
    else:
        print("\nEmpate total!!")
