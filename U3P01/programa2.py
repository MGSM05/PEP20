...
def saludar(nombre, primer_apellido, segundo_apellido, curso = "2DAW"):
    print(f"Hola me llamo {nombre} {primer_apellido} {segundo_apellido} y estoy en {curso}")

saludar("Mario", "Gonzalez", "San Martin")
saludar(primer_apellido="Sanchez", nombre="Jaime", segundo_apellido="Diaz")